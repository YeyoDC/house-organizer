...
<nav class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow sm:hidden z-40">
    <div class="flex justify-around items-center h-14 text-sm">
        <a href="#"  class="{{ $routeName === 'chores.index' ? 'text-indigo-600 font-semibold' : '' }}">🏠 <span class="block text-xs"> Home </span></a>
        ...
        <a href="#" class="{{ $routeName === 'alerts.index' ? 'text-indigo-600 font-semibold' : '' }}">🔔<span class="block text-xs">Alerts</span></a>
    </div>
</nav>
